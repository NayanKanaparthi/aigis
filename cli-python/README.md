...
Built by [Nayan Kanaparthi](https://github.com/NayanKanaparthi/aigis) at NYU Stern's Berkley Center for Entrepreneurship. Inspired by conversations with Shailesh Prakash and the SWE-agent paper from Princeton Language and Intelligence.

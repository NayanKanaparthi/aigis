...
const ALL_TRAITS = [
  ...
  'is-eu-high-risk',    // v2.1: EU AI Act Annex III gating trait — pulls EU AI Act high-risk articles in brief assembly
];
...
const TRAIT_FILES = {
  ...
  ],   // v2.1: pulls EU AI Act high-risk areas. Brief assembly (Step 4) filters by jurisdiction-eu before rendering.
};
